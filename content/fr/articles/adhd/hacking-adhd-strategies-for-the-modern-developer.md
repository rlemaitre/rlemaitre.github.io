...
Après avoir lutté avec ma santé mentale (anxiété, état dépressif) pendant plusieurs années, j'ai été diagnostiqué avec un Trouble du Déficit de l'Attention/Hyperactivité, communément appelé TDAH, à l'âge de 44 ans.
...
>
> Je ne suis ni psychiatre ni neurologue, donc cette description est sûrement incomplète.

Le TDAH est un trouble neuro-développemental qui affecte les enfants et les adultes.
Selon le Manuel Diagnostique et Statistique des Troubles Mentaux (DSM-5) de l'Association Psychiatrique Américaine, le TDAH se caractérise par un schéma persistant d'inattention et/ou d'hyperactivité-impulsivité qui interfère avec le fonctionnement ou le développement.
...
![[xx_system/attachments/double-edged-sword.webp]]
...
![[xx_system/attachments/understanding-adhd-brain.webp]]
...
![[xx_system/attachments/adhd-work-environment.webp]]
...
En adoptant cette stratégie, nous nous assurons que chacun a la latitude nécessaire pour travailler d'une manière adaptée à sa capacité d'attention et à son modèle cognitif,
tout en préservant les avantages de la cohésion d'équipe.

## Stratégies et outils d'autogestion : Faire face aux symptômes du TDAH

![[xx_system/attachments/adhd-strategies-and-tools.webp]]
...
Quand je dois me concentrer intensément, j'allume [Brain.fm](https://brain.fm/).
